...
const Settings = () => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="overflow-x-auto mt-5 shadpw-md">
                        ...
                        <tr className="hover:bg-blue-50" key={setting.label}>
                            ...
                            <td className="py-2 px-4">
                                {setting.type === "toggle" ? (
                                    ...
                                    <input type="text" className="px-4 py-2 border rounded-lg text-gray-500 focus:outline-none
                                    focus:border-blue-500" value={setting.value as string}
                                           onChange={(e) => {
                                               const settingsCopy = [...settings];
