    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 xl:overflow-auto gap-10 pb-4 custom-grid-rows">
            ...
            <StatCard title="Customer & Expenses"
                      ...
                      details={[
                          ...
                          },
                          {
                              ...
                              changePercentage: -56, IconComponent: TrendingDown
                          },
            ...
            <StatCard title="Dues & Pending Orders"
                      ...
                      details={[
                          {
                              title: "Dues", amount: "250.00",
                              changePercentage: 131, IconComponent: TrendingUp
                          },
                          {
                              title: "Pending Orders", amount: "147",
                              changePercentage: -56, IconComponent: TrendingDown
                          },
                      ]}/>
            <StatCard title="Sales & Discount"
                      ...
                      details={[
                          {
                              title: "Sales", amount: "1000.00",
                              changePercentage: 20, IconComponent: TrendingUp
                          },
                          {
                              title: "Discount", amount: "200.00",
                              changePercentage: -10, IconComponent: TrendingDown
                          },
