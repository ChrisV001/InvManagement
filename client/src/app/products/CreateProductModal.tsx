...
const CreateProductModal = ({isOpen, onCreate, onClose}: CreateProductModalProps) => {
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-20">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                ...
                <form onSubmit={handleSubmit} className="mt-5">
                    ...
                    <input type="text" name="stockQuantity" placeholder="Stock Quantity"
                    ...
                    <button type="button" className="ml-2 px-4 py-2 bg-gray-500 text-white rounded
                    hover:bg-gray-700" onClick={onClose}>
                        Cancel
                    </button>
                </form>
            </div>
