...
import {Archive, Layout, Clipboard, LucideIcon, Menu, User, SlidersHorizontal, CircleDollarSign} from "lucide-react";
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            <div
                ...
                <div>logo</div>
                <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>KVSTOCK</h1>
            </div>
            ...
            <div className="flex-grow mt-8">
                ...
                <SidebarLink href="/inventory" icon={Archive} label="Archive" isCollapsed={isSidebarCollapsed} />
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
                <p className="text-center text-xs text-gray-500">&copy; 2024 KVSTOCK</p>
            </div>
        </div>
    );
}
